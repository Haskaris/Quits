 ...
 * @author Mathis
 */
public class EditPlayerAuto extends javax.swing.JPanel {
    
    public String playerName;
    public Color playerColor;
    public Tools.AILevel aiLevel;
    public ColorPicker colorPicker;

    /** Creates new form EditPlayerAuto */
    public EditPlayerAuto(String playerName, Color playerColor) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Humain", "Ordinateur facile", "Ordinateur normal", "Ordinateur difficile" }));
